...
class SignUpView extends GetView<LoginController2> {
        ...
        body: Padding(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                SizedBox(height: 50),
                Center(child: Text('Sign Up'.toUpperCase(),style: TextStyle(color: AppColors.light_main,fontWeight:FontWeight.bold,fontSize: 30),),
                ),
                SizedBox(height: 50),
                  ...
                  Padding(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(color: AppColors.mainColor2,width: 2),
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            ),child: Center(child: Text("Full Name",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 16),),),
                          ),SizedBox(width: 10,),Expanded(child: TextFormField(
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              color: AppColors.mainColor2
                            ),child: Center(child:  Text("Email",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 16),),),
                          ),SizedBox(width: 10,),Expanded(child: TextFormField(
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              color: AppColors.mainColor2
                            ),child: Center(child: Text("Phone",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 16),),),
                          ),SizedBox(width: 10,),Expanded(child: TextFormField(
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              color: AppColors.mainColor2
                            ),child: Center(child: Text("Password",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 16),),),
                          ),SizedBox(width: 10,),Expanded(child: Obx(() =>  TextFormField(
