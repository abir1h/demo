...
class openFoood extends StatefulWidget {
  final String id;

  const openFoood({Key? key,required this.id}) : super(key: key);

  @override
  State<openFoood> createState() => _openFooodState();
}

class _openFooodState extends State<openFoood> {
  ...
  Future allExperience(String id,String locationid,String SublocationID) async {
    ...
    var response =
    await http.get(Uri.parse(AppUrl.view_all_restruentFood+id+ "/" + locationid + '/' + SublocationID), headers: requestHeaders);
