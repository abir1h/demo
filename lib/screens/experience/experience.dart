...
class singleexperience extends StatefulWidget {
  final String id;

  const singleexperience({Key? key,required this.id}) : super(key: key);

  @override
  State<singleexperience> createState() => _singleexperienceState();
}

class _singleexperienceState extends State<singleexperience> {
  ...
  Future allExperience(String id,String locationid,String SublocationID) async {
    ...
    var response =
    await http.get(Uri.parse(AppUrl.singleexperience+id+ "/" + locationid + '/' + SublocationID), headers: requestHeaders);
