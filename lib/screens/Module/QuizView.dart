                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  snapshot.data[index]['attemt_exam'] > 0
                                      ? InkWell(
                                          onTap: () {
                                            controller.examid.value = snapshot
                                                .data[index]['id']
                                                .toString();
                                      Get.to(()=>QuizDetails(),transition: Transition.rightToLeft,duration: Duration(milliseconds: 500));
                                          },
                                          child: Container(
                                            height: 50,
                                            width: size.width,
                                      ...
                                      : InkWell(
                                          onTap: () {
                                            controller.examid.value = snapshot
                                                .data[index]['id']
                                                .toString();
                                            Get.to(() => QuizAttempt(time: snapshot
                                                .data[index]['exam_time'].toString() ),
                                                transition:
