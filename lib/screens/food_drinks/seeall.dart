...
class foodDrinks_seeAll extends StatefulWidget {
  final String id;
  const foodDrinks_seeAll({Key? key,required this.id}) : super(key: key);

  @override
  State<foodDrinks_seeAll> createState() => _foodDrinks_seeAllState();
}

class _foodDrinks_seeAllState extends State<foodDrinks_seeAll> {
  ...
  Future allExperience() async {
    ...
    var response =
    await http.get(Uri.parse(AppUrl.foodDrinks+widget.id), headers: requestHeaders);
