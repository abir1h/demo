...
class newly_open_viewall extends StatefulWidget {
  const newly_open_viewall({Key? key}) : super(key: key);

  @override
  State<newly_open_viewall> createState() => _newly_open_viewallState();
}

class _newly_open_viewallState extends State<newly_open_viewall> {
  ...
  Future allExperience() async {
    ...
    var response =
    await http.get(Uri.parse(AppUrl.newlyOpenViewall+locaitonid!+"/"+subid!), headers: requestHeaders);
